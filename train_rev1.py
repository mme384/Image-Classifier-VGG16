...
"""
    ...
    SAMPLE COMMAND LINE: python3 train_rev1.py --file_path "C:/Users/meyer-4/001_UdacityAIProgrammingwPythonFinalProject/flowers" --arch "vgg16" --epochs 5 --batch_size 64 --gpu "gpu" --running_loss True --valid_loss True --valid_accuracy True --test True
